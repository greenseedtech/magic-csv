...
module.exports = CSV = (function() {
  ...
  CSV.prototype.readObjects = function(data, callback) {
    var bestIndex, col, i, key, keys, new_val, ob, row, val, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref;
    ...
    bestIndex = (function(_this) {
      return function(vals, val) {
        var j, regex, _j, _k, _l, _len1, _len2, _ref, _ref1, _ref2;
        if (_this._columns.length === 0) {
          return 0;
        }
        if (val.length > 2) {
          for (i = _j = _ref = val.length - 2; _ref <= 2 ? _j <= 2 : _j >= 2; i = _ref <= 2 ? ++_j : --_j) {
        ...
        _ref2 = vals.slice().reverse();
        for (i = _l = 0, _len2 = _ref2.length; _l < _len2; i = ++_l) {
          val = _ref2[i];
          if (__indexOf.call(_this._columns, val) >= 0) {
            continue;
          }
          return -i;
        }
    ...
    for (_m = 0, _len4 = _ref.length; _m < _len4; _m++) {
      row = _ref[_m];
      for (i = _n = 0, _len5 = row.length; _n < _len5; i = ++_n) {
        val = row[i];
        if (row[i] == null) {
          row[i] = '';
        }
