...
module.exports = CSV = (function() {
  ...
  CSV.prototype.parse = function(data, callback) {
    var allow_row, bad_rows, char, char_counts, col, cols, cols_found, delimiter, delimiter_types, end, end_index, ending, ends, getNextColumnName, i, index, j, line, line_ending, line_index, max_field_count, min_field_count, min_index, name, new_row, newline_flag, quoted, row, seek, start, start_index, starts, v, val, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3;
  ...
  CSV.prototype._finalize = function() {
    var blank_col, col, empty, empty_cols, i, row, val, vals, _base, _base1, _base2, _base3, _base4, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3;
    _ref = this._rows;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      row = _ref[_i];
    ...
    _ref2 = empty_cols.slice().reverse();
    for (_m = 0, _len4 = _ref2.length; _m < _len4; _m++) {
      col = _ref2[_m];
      blank_col = __indexOf.call(this._blank_cols, col) >= 0;
      if (!(this.settings.drop_empty_cols === true || blank_col)) {
        continue;
      }
      if (blank_col) {
        empty_cols.splice(empty_cols.indexOf(col), 1);
        this._blank_cols.splice(this._blank_cols.indexOf(col), 1);
      } else {
