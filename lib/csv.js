...
CSV = (function() {
  ...
  CSV.prototype._finalize = function(callback) {
    var c, col, cols, csv, dup_col, dup_cols, dups, empty, empty_cols, generated, i, j, ops, row, rows, str, val, vals, _base, _base1, _base2, _base3, _base4, _i, _j, _k, _l, _len, _len1, _len10, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _s;
    _ref = this._rows;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      row = _ref[_i];
